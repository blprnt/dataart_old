...
String apiKey = "be41935951a72c66ec6c7e1f982b6178:8:69800778";
...
void setup() {
  ...
  int[] monkeyCounts = doASearchYears("tomato", 1915, 2015);
  ...
  PrintWriter writer = createWriter("data/tomatoData.csv");
