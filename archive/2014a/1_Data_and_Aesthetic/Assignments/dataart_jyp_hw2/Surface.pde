...
class Surface {
  ...
  Surface() {
    ...
    /*
    surface.add(new Vec2(0, 50));
    surface.add(new Vec2(width/2, height/2+350));
    surface.add(new Vec2(width, 50));
    */
  ...
  void display() {
    ...
    rect(550, height/2+280, 50, 100);
    rect(700, height/2+280, 50, 100);
    popMatrix();
    //strokeWeight(1);
    noFill();
    noStroke();
