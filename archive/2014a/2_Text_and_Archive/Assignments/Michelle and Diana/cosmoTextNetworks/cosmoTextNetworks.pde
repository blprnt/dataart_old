...
Text and Archive
By Michelle and Diana
michelle.chandra@gmail.com

How have communications to women changed overtime?  What does Cosmopolitan Magazine represent to women and 
how has it changed from 1965 when Helen Gurley Brown took over to current day?  We looked at headlines on  
“Cosmo” magazine covers from 1965-1973 and compared to headlines written from 2009 to 2012. We used a simple
Python program to randomly generate headline mash-ups and used the resulting text to create our own generative
text Cosmo magazine cover. 

The below Processing sketch takes the 2014 headlines and creasse a word network visualization of the 50 most
frequent words.
...
void setup() {
  ...
  makeTextNetwork("data/cosmo2000.txt");
  makeStopList("data/stoplist.txt");
